...
const TrainerThird = ({ handleDataUpload }: TrainerThirdProps) => {
  ...
  return (
    <div className="p-4  select-none ">
      {/* 照片及自介 */}
      <div className="p-6 border border-black rounded-xl space-y-10">
        <div className="flexBetween space-x-6">
          ...
          <div className="space-y-4 w-full">
            <div className="flexCenter space-x-4">
              <p className="text-5xl">{userData?.name}</p>
              <IconButton
              ...
              <div
                className="cursor-pointer icon-button mt-3"
          ...
          <div className="">
            <div className="flex  ">
              {Navbar.map((item, index) => (
                <div className="">
                  <p className={`text-xl font-bold ${index !== 0 ? 'ml-10' : 'ml-3'} ${navStep === index ? 'text-[#61A3BA]' : '' }`} onClick={()=>setNavStep(index)}>
                    {item}
                  </p>
                </div>
              ))}
