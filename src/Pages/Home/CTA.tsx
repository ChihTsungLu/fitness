...
const CTA = ({}: CTAProps) => {
  return (
    <div className="p-20 flexCenter space-x-6 select-none">
      <div className="flex items-center flex-col w-[580px] border h-[590px] rounded-xl bg-[#1F2123] text-white p-16 ">
      ...
      <div className="flex items-center flex-col w-[580px] border h-[590px] rounded-xl bg-[#DDF2FD] text-white p-16 ">
