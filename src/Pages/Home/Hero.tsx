...
const Hero = ({ }: HeroProps) => {
  ...
  return (
    <div className=" h-[650px] mt-[65px] flex items-end relative hero-image ">
      ...
      <h1 className=" text-white text-3xl mb-10 w-full ml-20 text-center font-extrabold"><CheckCircleOutlineIcon /> 流通產業資訊 <CheckCircleOutlineIcon />達成目標體態 <CheckCircleOutlineIcon />滿足心靈健康</h1>
